...
val get_at : t -> string -> int -> (Value.t option, string) result
val get_fn : t -> string -> closed_function
val get_fn_at : t -> string -> int -> closed_function
...
val assign_at : t -> string -> int -> Value.t option -> (unit, string) result
val print : t -> unit
